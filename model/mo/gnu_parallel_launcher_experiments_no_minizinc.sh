...
SOLVER_TIMEOUT=3600
SUMMARY_FILE="../summary_mokps.csv"
FIXED_PARAMETERS="--minizinc_data 0 --model_mzn ../mosaic_cloud2.mzn --dzn_dir ../data_sets/ --solver_timeout_sec $SOLVER_TIMEOUT --summary $SUMMARY_FILE --cores $CORES --solver_search_strategy free --fzn_optimisation_level 1"
